...
function renderAllTodos(){
  ...
  TodoList.forEach((todo) => {
    todosHTML += `<div class="div_container" id=><li class='li page-item disabled '>
    <input type='checkbox' class="123" id='get_'>
    <label></label>   
    <span class="task__delete"> <img src="icon.png"/> </span>
  </li></div>`;
  })
  let OurTask=
    `<div class="div_container" id=><li class='li page-item disabled '>
      <input type='checkbox' class="123" id='get_'>
      <label></label>   
      <span class="task__delete"> <img src="icon.png"/> </span>
    </li></div>`;
