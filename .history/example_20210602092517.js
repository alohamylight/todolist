...
создаю константу, куда записываю этот таск - cont  //[deletedTask] = МассивТасков.filter(obj => obj.id === deletedTask.id);
Затем нахожу индекс этого элемента в МассивеТасков - const deletedIndex = МассивТасков.indexOf(deletedIndex);
