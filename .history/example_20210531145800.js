...
function MyFunc(){
  ...
  let OurTask=
    `<li>
      <input type='checkbox' onkeyup="document.getElementById('input2').value=this.value" id='item_${Date.now()}' id='123' ${item.checked ? 'checked': ''}> 
      <span>${item.todo}</span>
    </li>`;
...
<input id='123' onkeyup="handle()" value=""/>
